...
describe('Test Built-in function typechecks', () => {
    ...
    testArgtype('concat', (a) => `concat(${a}, [])`, ['[]'], notArray)
    testArgtype('concat', (a) => `concat([], ${a})`, ['[]'], notArray)
    testArgtype('join', (a) => `join(${a}, ",")`, ['[]'], notArray)
    testArgtype('join', (a) => `join([], ${a})`, ['","'], notString)
    ...
    testArgtype('sin', (a) => `sin(${a})`, ['1', '1.5'], notNum);
    testArgtype('cos', (a) => `cos(${a})`, ['1', '1.5'], notNum);
    testArgtype('tan', (a) => `tan(${a})`, ['1', '1.5'], notNum);
    testArgtype('arcsin', (a) => `sin(${a})`, ['1', '1.5'], notNum);
    testArgtype('arccos', (a) => `cos(${a})`, ['1', '1.5'], notNum);
    testArgtype('arctan', (a) => `tan(${a})`, ['1', '1.5'], notNum);
